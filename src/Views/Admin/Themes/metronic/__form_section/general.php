...
<div class="form-group form-group-sm row">
    ...
    <div class="col-lg-9 col-xl-6">
        <select required name="etat" class="form-control selectpicker file kt-selectpicker" publied-actions-box="true" title="<?= ucfirst(lang('Core.choose_one_of_the_following')); ?>" id="etat">
...
<div class="form-group form-group-sm row">
    ...
    <div class="col-lg-9 col-xl-6">
        <select required name="id_categorie" class="form-control selectpicker file kt-selectpicker" multiple publied-actions-box="true" title="<?= ucfirst(lang('Core.choose_one_of_the_following')); ?>" id="id_categorie">
            <?php foreach ($form->categories as $categorie) { ?>
                <option <?= $categorie->id_categorie == $form->id_categorie ? 'selected' : ''; ?> value="<?= $form->id_categorie; ?>"><?= $categorie->getNameLang(service('Settings')->setting_id_lang); ?></option>
            <?php } ?>
        </select>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-9 col-xl-6">
        ...
        <span class="form-text text-muted"><?= lang('Core.Voir la page :'); ?> <a target="_blank" href="<?= base_urlFront('articles/' . $form->slug); ?>"><?= base_urlFront('articles/' . $form->slug); ?></a></span>
